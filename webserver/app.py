        ...
        with open(audio_file_path, "wb") as audio_file:
            while True:
                ...
                if data == "END":
                    ...
                    # Process the audio data and send emotion
                    if audio_data:
                        ...
                        print(f"Columns: {aligned_features.columns.tolist()}")
                        ...
                        await websocket.send("No valid audio data received".encode())
...
if __name__ == "__main__":
    ...
    print("Make sure to run the client script to test the audio streaming functionality")